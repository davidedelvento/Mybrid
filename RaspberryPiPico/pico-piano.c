...
#define MIDI_DUMP_NOTE_ADC       0x7C   // custom command to start sending ADC data over MIDI
#define MIDI_STOP_DUMP_ADC       0x3C   // custom command to stop  sending ADC data over MIDI
#define MIDI_REGULATE            0x4E   // custom command to start regulating one note
#define MIDI_CONTINUE_REGULATION 0x1C   // custom command to continue (or finish) regulating
#define MIDI_DUMP_REGULATION     0x0D   // custom command to dump regulation parameters for one note
#define MIDI_END_SYSEX           0xF7   // End of System Exclusive, aka EOX

#define INIT_PICO                0x2D   // custom command to init each pico (observed only at the beginning)

#define MIDI_ITER_PER_MS         0x40   // bits the ADC will never use, adding one for each pico, can be max 0x7C
#define MIDI_NO_SUCH_NOTE        0x7D   // bits the ADC will never use
#define MIDI_ERROR               0x7E   // bits the ADC will never use
